...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        //std::string sDLLPath = std::string(pcModPath).substr(0, std::string(pcModPath).length() - 33) + "ETM-x86.dll";
        std::cout << std::string(pcModPath) << "\n";
        std::string sDLLPath = "ETM-x86.dll";
        //a
